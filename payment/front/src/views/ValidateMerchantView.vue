<template>
    <aside class="h-auto w-full overflow-scroll">
        ...
        <template v-else>
            <!-- <ValidateMerchant v-for="merchant in merchants" :key="merchant.id" :merchant="merchant" /> -->

            <ValidateMerchant
                v-for="merchant in merchants"
                :key="merchant.id"
                :merchant="merchant"
                @merchant-accepted="handleMerchantAccepted"
            />
        </template>
        </div>
    </aside>
...
<script setup>
    import { ref } from 'vue';
    import ValidateMerchant from '@/components/components/ValidateMerchant.vue';
    ...
    apiService.getPendingMerchants()
    .then((response) => {
